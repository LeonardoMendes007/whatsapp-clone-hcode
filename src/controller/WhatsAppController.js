...
import { onSnapshot, setDoc, query, orderBy, collection, getDocs} from "firebase/firestore";
...
export class WhatsAppController{
    ...
    setActiveChat(contact){
        ...
        onSnapshot(query(Message.getRef(this._contactActive.chatId), orderBy("timeStamp")), docs => {
